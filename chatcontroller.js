...
class ChatController {
    async createChat (req,res){
        try {
            let chatId= await ChatService.createChat(req.params.commonId,req.params.secondId)
    ...
    async postMessage(req,res){
        try{
            ...
            let result=await ChatService.postMessage(req.body.chatId,req.body.author,req.body.msg)
